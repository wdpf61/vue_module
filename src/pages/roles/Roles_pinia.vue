        ...
        <div class="col">
            <div class="card">
                <div class="card-header">
                 ...
                 <div v-if="rolesData.loading">
                  <img src="https://media.tenor.com/wpSo-8CrXqUAAAAm/loading-loading-forever.webp" alt="" srcset="">
                </div>
                <div v-if="rolesData.error"> {{ rolesData.error }}</div>
                  ...
                  <div v-if="roleStore.error" style="color:red">{{ roleStore.error }}</div> -->
                    <div>
                        <table class="table table-striped">
                            ...
                            <tbody>
                                <tr v-for="role in rolesData.roles" :key="role.id">
                                    <th>{{ role.id }}</th>
                                    <th>{{ role.name }}</th>
                                    <th>
