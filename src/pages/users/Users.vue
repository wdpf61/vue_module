                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <div class="employee mb-3">
                                                    ...
                                                    <input class="form-control" type="text" id="employee-field"
                                                        placeholder="employee" required="">
                                                </div>

                                                <div class="email mb-3">
                                                    <label class="form-label">Email :</label>
                                                    <input class="form-control" type="email" id="email-field"
                                                        placeholder="email" required="">
                                                </div>

                                                <div class="contact mb-3">
                                                    <label class="form-label">contact :</label>
                                                    <input class="form-control" type="text" id="contact-field"
                                                ...
                                                <div class="status mb-3">
                                                    ...
                                                    <select class="form-select" id="status-field"
...
const fetchUsers = async (url = 'http://localhost/Laravel/project/public/api/users') => {
    const response = await axios.get(url, { params: { search: search.value } });
